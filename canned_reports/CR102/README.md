...
PLEASE NOTE: THIS QUERY AND DOCUMENTATION ERE WRITTEN FOR ALL FOLIO MEMBER USERS (I.E., NOT SPECIFICALLY FOR CUL). THIS QUERY AND DOCUMENTATION WIL LBE UPDATED FOR CUL AS TIME ALLOWS.  FOR NOW, DON'T ASSUME IT WILL GIVE YOU FULLY CORRECT RESULTS.
